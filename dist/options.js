...
const App = () => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", { className: "text-5xl text-green-700 font-medium" }, "Options Page"),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: "healthy-food.jpg", alt: "healthy-food" })));
};
const container = document.createElement("div");
document.body.appendChild(container);
(0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(container).render(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(App, null));
